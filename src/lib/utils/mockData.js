...
// Discovery content for category pages
export const getDiscoveryContent = (category) => {
  const allContent = {
    theories: mockTheories.slice(0, 9),
    animations: [
      {
        id: 1,
        title: "Demon Slayer: Water Breathing Animation Breakdown",
        creator: "SakugaExpert",
        image: "/api/placeholder/400/300",
        tags: ["demon-slayer", "animation", "ufotable"],
        views: 45200,
        likes: 892,
        type: "animation"
      },
      {
        id: 2,
        title: "Jujutsu Kaisen: Domain Expansion VFX Analysis",
        creator: "AnimationStudio",
        image: "/api/placeholder/400/300",
        tags: ["jujutsu-kaisen", "vfx", "mappa"],
        views: 38100,
        likes: 743,
        type: "animation"
      },
      {
        id: 3,
        title: "Attack on Titan: 3D Maneuver Gear Physics",
        creator: "StudioWIT",
        image: "/api/placeholder/400/300",
        tags: ["attack-on-titan", "3d", "physics"],
        views: 52000,
        likes: 1204,
        type: "animation"
      }
    ...
    creators: [
      {
        id: 1,
        title: "InkMaster: The Rising Mangaka",
        creator: "Shonen Ark",
        image: "/api/placeholder/400/300",
        tags: ["creator-spotlight", "manga", "artist"],
        views: 12400,
        likes: 567,
        type: "creator"
      },
      {
        id: 2,
        title: "TheoryKing: Master of Predictions",
        creator: "Community",
        image: "/api/placeholder/400/300",
        tags: ["theorist", "predictions", "analysis"],
        views: 18900,
        likes: 892,
        type: "creator"
      }
  ...
  return allContent[category] || allContent.theories;
};
