  ...
  movies: [
    {
      ...
      status: "NOT_YET_RELEASED",
      format: "MOVIE",
      description: "A new adventure awaits the Straw Hat crew in this epic film.",
      genres: ["Action", "Adventure", "Comedy"],
      startDate: { year: 2025, month: 5, day: 20 }
    },
    {
      id: 7,
      title: "My Hero Academia: World Heroes Rising",
      coverImage: "/api/placeholder/300/400",
      status: "FINISHED",
      format: "MOVIE",
      description: "Heroes unite to face a global threat.",
      genres: ["Action", "School", "Super Power"],
      startDate: { year: 2024, month: 12, day: 20 }
    }
  ]
};
